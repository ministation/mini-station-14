...
alert-level-omicron-announcement =
    Активирован приоритет станции.
    Ожидайте дальнейших указаний от Центрального Командования.
    Оставайтесь в своих отделах.
alert-level-omicron-instructions = Ожидайте дополнительных распоряжений.


<<<<<<< HEAD
alert-level-octarine = Октарин
alert-level-octarine-announcement =
    Катаклизмическое событие в ноосфере угрожает поглотить реальность.
    Экипажу предписано локализовать угрозу или начать эвакуацию.
alert-level-octarine-instructions =
    Всем членам экипажа надлежит следовать указаниям командного состава.
=======
